...
\abstract{Women's entrepreneurship in agriculture is recognized as an important factor in inclusive growth; however, empirical data on the transition economies of Central Asia remain underresearched. This study analyzes the causal influence of institutional agricultural lending on the development of women-owned farms in 20 regions of Kazakhstan over the period 2015--2024 (175 observations). We employ a three-module analytical approach: (1) two-way fixed-effects panel regressions to identify causal relationships; (2) k-means clustering to account for regional heterogeneity; and (3) the random forest method to assess the predictive power of variables. Access to credit does not have a statistically significant causal effect on the number of female-headed farms in the region after controlling for fixed effects, despite a positive correlation in the pooled OLS model. The clustering results reveal two distinct regional groups: the first is characterized by a high level of female farming but relatively low growth, whereas the second starts from lower initial indicators but grows three times faster. In neither group do we find evidence that lending specifically drives this dynamic. Access to land emerges as the more significant factor: on average, women own only 2.01\% of agricultural land (median 1.19\%), which acts as an institutional constraint on female entrepreneurship. These findings indicate that simply increasing the volume of lending is insufficient and that differentiated, region-specific measures combining financial instruments with reforms in land rights and regional infrastructure are required.}
...
The literature also reveals a contradiction in the assessment of the
role of large agro-industrial enterprises. Partnership with large
companies is often viewed as a driver of inclusive growth
\citep{ref34}, whereas other studies show that large farms can dictate
terms and exacerbate inequality among smallholder producers
\citep{ref90}.

Discussion of technological and digital innovations follows a similar
pattern. Some studies regard digitalization as a mechanism for reducing
transaction costs and expanding access to resources \citep{ref105,ref72,ref43,ref37,ref104},
while others argue that without institutional reform these tools may
reinforce existing asymmetries \citep{ref28}.
...
factors: access to credit as a financial mechanism and access to land as
...
The systematic logic of the study's design follows a three-stage
sequence. First, the presence of a causal relationship is tested
through panel econometric analysis \citep{ref22,ref53,ref101}. Second,
the structural context of the phenomenon is examined through cluster
analysis. Third, the predictive significance of the results is assessed
...
A logarithmic transformation was applied to prepare the data for
...
fixed-effects (TWFE) model showed that after accounting for regional
...
outcomes and confirmed a significant correlation between loans and women
...
\section{Implications of the results for improving agricultural policy in Kazakhstan}
...
agricultural land owned by women is only 2.01\% (median 1.19\%). The
...
Aimurzina B. developed the concept, supervised the entire study,
collected and analyzed the data, wrote the initial draft, and reviewed
it. Arzayeva T. participated in the concept development, validation,
writing, and editing. Bulakbay Zh. participated in the concept
development, writing, and editing. Mataibaeva G. participated in the
concept development, writing, and editing. Sadvakassov R. participated
